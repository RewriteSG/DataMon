...
[CreateAssetMenu(fileName = "Mount_", menuName = "Abilities/Mount/Add Centaur", order = 0)]
public class MountCentaur : AbilitiesScriptableObjects
{
    ...
    public override void Activate(DataMonsData dataMonData, DataMonIndividualData dataMon, GameManager Player, bool toggle)
    {
        ...
        Player.MaxShieldHealth = ModifiersByEvolution[dataMonData.DataMons.GetDataMonIndexInDataArray(dataMon.DataMonName)];
        Player.ShieldBar.SetMaxHealth(Player.MaxShieldHealth);
